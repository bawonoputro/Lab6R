...
```{r}
start_time <- Sys.time()
result <- brute_force_knapsack(x = knapsack_objects[1:15,], W = 3500)
end_time <- Sys.time()
...
result_brute_force
cat("time solving n=16 with standard brute force is:", execution_time_brute_force, "seconds")
```
...
knapsack_objects <- data.frame(
  ...
  result_parallel <- parallel_brute_force_knapsack(x = knapsack_objects[1:15,], W = 3500)
